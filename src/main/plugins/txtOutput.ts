...
export default class TxtOutputPlugin {
    /**
     * Base Plugin Details (Eventually implemented into a GUI in settings)
     */
    public name: string = 'TXT Output';
    public description: string = 'A plugin to output song information to a text file.';
    public version: string = '0.0.1';
    public author: string = 'Chase Ingebritson';
    public fileName: string = 'txtOutput.txt'
    public template: string = `$$t - $$a [$$l] (prod. $$c)`
    public fields = [
    ...
    private _app: any;
    private _store: any;
    private _pluginPath = resolve(electron.app.getPath('userData'), `./plugins/txt-output`);
